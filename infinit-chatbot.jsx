          ...
          {showWelcome && (
            <div style={{ animation: "fadeIn 0.4s ease-out", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", flex: 1, gap: 24, paddingBottom: 40 }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
                ...
                <div style={{ fontSize: 13, color: "rgba(255,255,255,0.3)", fontWeight: 600, maxWidth: 500, textAlign: "center", lineHeight: 1.5 }}>Hello, explorer. I'm Infinit — your STEM companion. Got questions about space, machines, numbers, nature, or how things work? You're in the right place. No question is too big or too small.</div>
